...
You can GET all followings of a user in `/api/v1/users/{userId}/followings`.
...
### Create
Create a following, e.g. follow another user

```http
POST /api/v1/users/1/followings/12 HTTP/1.1
Micropost-Agent: MyClient/1.0.0
Accept: application/vnd.api+json
```
```http
...
Here, user 1 starts following user 2.



### Destroy
Delete a following, e.g. somebody that you follow

```http
DELETE /api/v1/users/1/followings/12 HTTP/1.1
Micropost-Agent: MyClient/1.0.0
Accept: application/vnd.api+json
```
```http
